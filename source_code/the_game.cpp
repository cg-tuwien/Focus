...
public: // v== cgb::cg_element overrides which will be invoked by the framework ==v
	...
	void initialize() override
	{
		...
		for (const auto& pair : distinctMaterialsOrca) {
			...
			break; // TODO: Das kann man wieder weglöschen... ist nur zu Testzwecken hier
		}
		...
		// 
		// 
		// Ja... sorry, dass es hier so ausschaut.
		// Der folgende Code war eigentlich nur als temporäres Ding gedacht, aber ich habe dann ein Problem bekommen,
		// das ich nicht mehr lösen konnte (siehen bei den DescriptorSets)
		//
		//	Bzw. im nachfolgend generierten Command Buffer habe ich eh auch irgendwo einen Fehler (vermutlich bei
		//	einer Barrier?) aber nix fatales (denke ich). Fatal wird es bei den DescriptorSets.
		//
		//	Der Code hier ist auch (noch) nicht sonderlich schön, das muss noch viel mehr abstrahiert werden.
		// 
		// 
	...
	void render() override
	{
		...
		//
		//
		// Keine Ahnung warum, aber bei bindDescriptorSets bekomme ich eine Access Violation.
		// Das ist sehr sehr schlecht.
		//
		// Hier musste ich dann schlussendlich aufgeben, weil 1.) kann ich eh schon nicht mehr
		// klar denken und 2.) wäre das wohl noch eine längere Suche.
		//
		// Auch hier: Nicht alles ist schön abstrahiert. Da sollte wohl noch einiges getan werden.
		//
		//
